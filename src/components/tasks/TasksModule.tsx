...
// Linked Resources Editor - for adding/removing bookmark links to tasks
...
function LinkedResourcesEditor({ linkedBookmarkIds, onChange, searchQuery, onSearchChange }: LinkedResourcesEditorProps) {
...
// Entity Link Input with autocomplete for [[entity]] syntax
...
function EntityLinkInput({ value, onChange, placeholder, className }: EntityLinkInputProps) {
